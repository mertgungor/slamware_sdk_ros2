...
namespace slamware_ros_sdk {
    ...
    public:
        ...
        rpos::core::RectangleI fillRosMapMsg(const rpos::core::RectangleI& reqIdxRect, nav_msgs::msg::OccupancyGrid& msgMap) const;
        rpos::core::RectangleI fillRosMapMsg(const rpos::core::RectangleF& reqArea, nav_msgs::msg::OccupancyGrid& msgMap) const;
        rpos::core::RectangleI fillRosMapMsg(nav_msgs::msg::OccupancyGrid& msgMap) const;
